...
export default {
    data() {
        return {
            bannerData : [
                {'banner_title': '免费建站  免费空间   免费域名','banner_text': '已累计为18,479,565个网站提供服务','banner_button': '马上咨询'},
                {'banner_title': '做一个精彩的站点','banner_text': '为情怀而干杯，告别朴素的重复和一望无际的平庸。','banner_button': '马上咨询'},
